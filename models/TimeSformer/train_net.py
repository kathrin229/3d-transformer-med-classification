...
# Code modiefied from https://github.com/facebookresearch/TimeSformer/blob/main/tools/train_net.py
# Adapted for different dataset and model
...
from data_loading import load_dataset_train_valid
...
def train_epoch(
    ...
    for cur_iter, (inputs, labels) in enumerate(train_loader):
        ...
        # Compute the loss.
        loss = loss_fun(preds, labels.long())
...
def build_trainer(cfg):
    ...
    train_loader = construct_loader_adapted(cfg, "train")
    val_loader = construct_loader_adapted(cfg, "val")
...
def train(cfg):
    ...
    torch.save(model, cfg.MODEL.MODEL_NAME)
...
def construct_loader_adapted(dataset, cfg, split, is_precise_bn=False):
    """
    ...
    dataset = dataset # build_dataset(dataset_name, cfg, split) #####
