...
# Code modiefied from https://github.com/facebookresearch/TimeSformer/blob/main/timesformer/utils/meters.py
# Deleted [ind] for labels[ind] due to different label configuration
# Change def finalize_metrics(self, ks=(1, 2)) from ks=(1, 5) as only 2 or 3 classes are classified 
...
class TestMeter(object):
    ...
    def update_stats(self, preds, labels, clip_ids):
        ...
        for ind in range(preds.shape[0]):
            vid_id = clip_ids #int(clip_ids[ind]) // self.num_clips
