...
# Code modiefied from https://github.com/facebookresearch/TimeSformer/blob/main/tools/test_net.py
...
from data_loading import load_dataset_test
    ...
    for cur_iter, (inputs, labels) in enumerate(test_loader):
        ...
        if cfg.DETECTION.ENABLE:
            ...
            test_meter.update_stats(
                preds.detach(), labels.detach(), cur_iter
            )
...
def test(cfg):
    ...
    model = torch.load(cfg.MODEL.MODEL_NAME)
    model.cuda()
