...
# Code modiefied from https://github.com/facebookresearch/TimeSformer/blob/main/timesformer/models/vit.py
# Implemented new space-only attention, space-limited attention, time-limited attention, space-and-time-limited attention
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        assert(attention_type in ['divided_space_time', 'space_only','joint_space_time', 'space_limited', 'time_limited', 'space_and_time_limited'])
        ...
        if self.attention_type == 'divided_space_time' or self.attention_type == 'space_limited' or self.attention_type == 'time_limited' or self.attention_type == 'space_and_time_limited':
    ...
    def forward(self, x, B, T, W):
        ...
        if self.attention_type in ['space_only', 'joint_space_time', 'space_only_new']:
        ...
        if self.attention_type == 'space_limited':
            ...
            cls_token = rearrange(cls_token, '(b t) m -> b t m',b=B,t=num_p)
