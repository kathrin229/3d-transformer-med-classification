...
loader_CP = np.load('data-arrays/dataset_CP.npz')
loader_NCP = np.load('data-arrays/dataset_NCP.npz')
loader_Normal = np.load('data-arrays/dataset_Normal.npz')
...
# Build model.
model = get_model(width=50, height=128, depth=128)
model.summary()
